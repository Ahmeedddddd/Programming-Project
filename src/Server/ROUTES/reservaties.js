...
router.put(
  ...
  async (req, res) => {
    ...
    console.log('[ACCEPT] Student number:', studentnummer);
    console.log('[ACCEPT] Company number:', bedrijfsnummer);
  ...
  async (req, res) => {
    ...
    try {
      ...
      if (deleted) {
        ...
        console.log('[DELETE] Delete failed');
